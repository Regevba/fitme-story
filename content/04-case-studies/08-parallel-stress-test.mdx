...
<ParallelGantt
  totalMinutes={54}
  lanes={[
    { feature: "Push Notifications", complexity: "Medium · permission handling", endedAt: 54, colorVar: "var(--skill-research)", phaseMark: "Testing 10/12" },
    { feature: "App Store Assets", complexity: "Low · visual assets, config", endedAt: 54, colorVar: "var(--skill-marketing)", phaseMark: "Impl 5/10" },
    { feature: "Import Training Plan", complexity: "High · multi-source parser, UI", endedAt: 54, colorVar: "var(--skill-dev)", phaseMark: "Testing 8/13" },
    { feature: "Smart Reminders", complexity: "High · AI-powered, 5 types", endedAt: 54, colorVar: "var(--skill-analytics)", phaseMark: "Testing 7/14" },
  ]}
...
<BeforeAfter
  before={{ label: "Serial v2.0 baseline", value: "390 min", subtitle: "1 feature" }}
  after={{ label: "Parallel v5.1", value: "54 min", subtitle: "4 features", accentVar: "var(--skill-qa)" }}
...
<DurationStack
  segments={[
    { label: "Research→PRD", minutes: 5, colorVar: "var(--skill-research)" },
    { label: "PRD→Tasks", minutes: 4, colorVar: "var(--skill-pm-workflow)" },
    { label: "Tasks→UX", minutes: 8, colorVar: "var(--skill-ux)" },
    { label: "UX→Impl", minutes: 5, colorVar: "var(--skill-design)" },
    { label: "Deep Impl", minutes: 4, colorVar: "var(--skill-dev)" },
    { label: "UI+Orchestrator", minutes: 3, colorVar: "var(--skill-dev)" },
    { label: "Analytics", minutes: 4, colorVar: "var(--skill-analytics)" },
    { label: "Testing", minutes: 17, colorVar: "var(--skill-qa)" },
  ]}
...
<RankedBars
  ...
  items={[
    { label: "Push Notifications", value: 15.0, colorVar: "var(--skill-research)", valueSuffix: " CU" },
    { label: "Import Training Plan", value: 12.0, colorVar: "var(--skill-dev)", valueSuffix: " CU" },
    { label: "Smart Reminders", value: 11.9, colorVar: "var(--skill-analytics)", valueSuffix: " CU" },
    { label: "App Store Assets", value: 5.0, colorVar: "var(--skill-marketing)", valueSuffix: " CU" },
  ]}
