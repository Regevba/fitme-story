...
upstream_path: docs/case-studies/framework-story-site-case-study.md
tier: standard
timeline_position:
  version: "6.1"
  order: 14
...
date: "2026-04-20"
tldr: 'PM framework built the website that hosts its own case studies. 37 commits over 2 hours of wall clock. 8 routes, 36 pre-rendered pages, 12 unit tests, 0 rollbacks. Recursion you can click through.'
key_numbers:
  - label: 'First commit → preview deploy'
    value: '2h 2m'
    tier: T1
  - label: 'Commits / rollbacks'
    value: '37 / 0'
    tier: T1
  - label: 'Pre-rendered pages / unit tests on day 1'
    value: '36 / 12'
    tier: T1
honest_disclosures:
  - "0 rollbacks during build; an SSR regression caught post-promotion (case study 15) is a separate failure mode that the build itself did not surface."
  - "Cache wasn't designed for site-build patterns — most reuse came from skill-on-demand loading + result forwarding. Pure pattern adaptation, not memorisation."
  - "Lighthouse 95+/100/100/100 was the design target — measured on the production deploy, not against a competitor benchmark."
visual_aid:
...
<HeroMetric value="2h 2m" label="first commit → preview deploy · 37 commits · 0 rollbacks" />
...
| V7.0 HADF | `<ChipAffinityMap />` | 17×7 heatmap, hover/focus shows readout |
