...
Tier 1 ships **uninstrumented for connect-rate** (baseline 0 — no source-attribution surface existed before). Primary target: ≥70% of users who complete the connect flow have a populated readiness score within 7 days [T2 — declared]. Kill checkpoint at 60 days: <20% connect-completion among Garmin-device Data-Sources openers ⇒ reassess Tier-1 UX vs jumping to a Tier-2 demand signal. First review 2026-06-26.
