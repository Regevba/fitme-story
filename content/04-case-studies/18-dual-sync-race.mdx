...
date: '2026-04-18'
tldr: "v7.0 audit's top backend finding — two sync paths (CloudKit + Supabase) both pull on login with no merge coordination. Last writer wins. Non-deterministic data loss in production for ~4 months."
key_numbers:
  - label: 'Sync findings / critical'
    value: '13 / 3'
    tier: T1
  - label: 'Time in production before discovery'
    value: '~4 months'
    tier: T2
  - label: 'Coexisting root-cause findings'
    value: '3 (DEEP-SYNC-001/002/003)'
    tier: T1
honest_disclosures:
    ...
    lanes:
      - label: 'CloudKit sync'
        ...
        events:
          ...
          - t: 120
            label: 'pull remote'
            detail: 'iCloud state A'
          - t: 260
            label: 'persistToDisk(A)'
      - label: 'Supabase sync'
