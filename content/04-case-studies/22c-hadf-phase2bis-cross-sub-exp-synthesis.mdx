...
visual_aid:
  ...
  data:
    beforeLabel: 'Phase 2 (predecessor, slot 22b)'
    before:
      label: 'cloud silhouette (k=5)'
      value: '0.5566'
      subtitle: 'n=700, 2 endpoints. The original cloud-generalization signal.'
    afterLabel: 'Phase 2-bis Sub-exp 1 (this synthesis)'
    after:
      label: 'cloud silhouette (k=5)'
      value: '0.7003'
      subtitle: 'n=2,600, 4 endpoints / 2 providers. One of 4 orthogonal sub-experiments — all PASS.'
    delta: '+25.8% generalization at ~3.7× the records — dispatch claim CONFIRMED (sensing layer)'
honest_disclosures:
