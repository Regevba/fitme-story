---
title: "The Most Complex Feature Completed at Refactor Speed"
slug: user-profile
upstream_path: docs/case-studies/user-profile-v4.4-case-study.md
tier: light
timeline_position:
  version: "4.4"
  order: 4
...
date: '2026-04-10'
tldr: 'First greenfield feature under v4.4 — new tab, new data model, 9 eval definitions, 5 views. Shipped in 2 hours end-to-end. Stress-tested whether prior velocity gains were pattern-memorisation or framework-real.'
key_numbers:
  - label: 'Wall time (research → Figma screen)'
    value: '~2 hours'
    tier: T2
  - label: 'Tests green (7 analytics + 9 evals)'
    value: '16 of 16'
    tier: T1
  - label: 'Tasks across 4 dependency layers'
    value: '13'
    tier: T1
honest_disclosures:
...
visual_aid:
  component: DurationStack
  data:
    caption: 'The complexity shape: 60 of 120 minutes was implementation. Upstream phases ate 40 minutes combined despite this being a greenfield feature with new data model + new tab + 9 eval definitions.'
    segments:
      - label: 'Research'
        minutes: 15
...
<HeroMetric value="2h" label="wall clock — first commit to shipped feature" />
...
<DurationStack
  segmentsJson='[
    ...
    {"label":"Implementation","minutes":60,"colorVar":"var(--skill-dev)"},
    {"label":"Testing","minutes":15,"colorVar":"var(--skill-qa)"},
    {"label":"Accessibility","minutes":5,"colorVar":"var(--skill-design)"}
  ]'
  caption="The complexity shape: 60 of 120 minutes was implementation. Upstream phases (research → tasks) ate 40 minutes combined despite this being a greenfield feature with new data model + new tab + 9 eval definitions."
/>
