---
title: V7.0 HADF — Teaching the Framework to Detect Chip Architecture
slug: hadf
...
visual_aid:
  component: ChipAffinityMap
---
# <Term slug="hadf">V7.0 HADF (Hardware-Aware Dispatch Framework)</Term> — Teaching the Framework to Detect Chip Architecture
