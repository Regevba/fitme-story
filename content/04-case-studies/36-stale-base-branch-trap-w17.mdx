...
visual_aid:
  ...
  data:
    beforeLabel: 'What gh pr view --json files reported (PR #488)'
    before:
      label: 'Files changed'
      value: '6'
      subtitle: 'gh counts commit-touched files against the branch''s ORIGINAL base SHA — looked routine, CI green.'
    afterLabel: 'What the merge would actually do'
    after:
      label: 'Merge-time diff'
      value: '23 files / −2157 lines'
      subtitle: 'Post-fork additions appear DELETED: HADF runbook, oldSSD addendum, R-track configs, integrity snapshot, UCC hardening study.'
    delta: 'cherry-pick onto fresh main is ground truth'
category: framework
---
