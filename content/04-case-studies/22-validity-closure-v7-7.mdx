...
date: '2026-04-28'
tldr: 'v7.7 closes A1–A5 + B1–B2 + C1 from the post-v7.6 gap inventory: 5 new gates (4 write-time pre-commit hooks + 1 cycle-time check + 1 advisory), bulk frontmatter backfill on 32 case studies, and timing backfill on 3 paused features. Framework reaches 25 mechanical gates + 1 advisory.'
key_numbers:
  - label: 'Post-v6 fully-adopted features'
    value: '2 of 9'
    tier: T1
  - label: 'Mechanical gates'
    value: '11 → 25'
    tier: T1
  - label: 'state ↔ case-study linkage'
    value: '95.5 → 100'
    tier: T1
honest_disclosures:
...
deferred_items:
  - title: 'Tier 1.1 trend mode'
    ledger: 'cron snapshot history at .claude/shared/measurement-adoption-history.json'
    reason: 'Wall-clock — needs 3 scheduled snapshots; earliest 2026-05-04.'
  - title: 'Tier 3.2 trend mode'
    ledger: '.claude/integrity/snapshots/'
    reason: 'Wall-clock — needs 3 scheduled 72h cycle snapshots.'
...
visual_aid:
  ...
  data:
    ...
    before:
      ...
      value: '11 gates'
      subtitle: '4 write-time + 7 cycle-time. cache_hits ungated. cu_v2 unchecked. linkage 95.5%.'
    afterLabel: 'v7.7'
    after:
      label: 'v7.7 (validity closure)'
      value: '25 gates + 1 advisory'
      subtitle: '4 new write-time + 1 cycle + 1 advisory. cache_hits gated. cu_v2 schema-validated. linkage 100%.'
    delta: 'A1-A5 + B1-B2 + C1 closed'
---
...
<BlueprintOverlay interactive activeAsOf="7.7" />
