...
upstream_path: docs/case-studies/onboarding-v2-auth-flow-v5.1-case-study.md
tier: flagship
timeline_position:
  version: '5.1'
  order: 6
...
date: '2026-04-13'
tldr: 'Auth embedded into onboarding mid-flow (vs separate hub). Full PM lifecycle plus 3 design iterations in a single 100-min session — first feature where post-merge runtime testing surfaced a critical bug invisible to the test suite.'
key_numbers:
  - label: 'Velocity vs baseline'
    value: '86% (2.1 min/CU)'
    tier: T1
  - label: 'Pre-merge phases / post-merge work'
    value: '38 min / 60 min'
    tier: T1
  - label: 'Issues found in post-merge manual testing'
    value: '6'
    tier: T1
honest_disclosures:
...
visual_aid:
  ...
  data:
    caption: 'The planned 9 phases cleared in 38 minutes. The unplanned post-merge manual testing + design iterations took 60 minutes — 60% of the total.'
    segments:
      - label: 'Research'
        minutes: 5
...
<HeroMetric value="86%" label="velocity improvement vs baseline (2.1 min/CU — best ever)" accentVar="var(--skill-qa)" />
...
<DurationStack
  segmentsJson={JSON.stringify([
    { label: "Research", minutes: 5, colorVar: "var(--skill-research)" },
    { label: "PRD", minutes: 5, colorVar: "var(--skill-pm-workflow)" },
    { label: "Tasks", minutes: 3, colorVar: "var(--skill-pm-workflow)" },
    { label: "UX Spec", minutes: 5, colorVar: "var(--skill-ux)" },
    { label: "Implementation", minutes: 15, colorVar: "var(--skill-dev)" },
    { label: "Testing", minutes: 3, colorVar: "var(--skill-qa)" },
    { label: "Review+Merge", minutes: 2, colorVar: "var(--skill-release)" },
    { label: "Manual testing", minutes: 30, colorVar: "var(--skill-cx)" },
    { label: "Design iterations", minutes: 30, colorVar: "var(--skill-design)" }
  ])}
  caption="The planned 9 phases cleared in 38 minutes. The unplanned post-merge manual testing + design iterations took 60 minutes — 60% of the total."
/>
...
| **<Term slug="complexity-units">Complexity Units</Term>** | **47.7** |
| Wall time | 100 min |
| **min/CU** | **2.1** |
| **Rank** | **1st (best ever)** |
...
<BeforeAfter
  beforeLabel="Onboarding v2.0 (baseline)"
  beforeValue="15.2 min/CU"
  beforeSubtitle="25.7 CU · ~6.5h wall time"
  afterLabel="Auth Flow v5.1"
  afterValue="2.1 min/CU"
  afterSubtitle="47.7 CU · 100 min wall time"
  afterAccentVar="var(--skill-qa)"
  delta="+86% faster, on 1.85× the complexity"
/>
