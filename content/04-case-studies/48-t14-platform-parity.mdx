...
visual_aid:
  ...
  data:
    title: '94 complete features backfilled in one mechanical pass — provenance split'
    items:
      - label: 'Heuristic-inferred'
        value: 61
        valueSuffix: ' features'
      - label: 'Framework-meta exempt'
        value: 25
        valueSuffix: ' features'
        colorVar: 'var(--color-neutral-500)'
      - label: 'Low-confidence flagged (optional spot-check)'
        value: 8
        valueSuffix: ' features'
    caption: '0 of the 94 required mandatory operator review — the 8 low-confidence inferences were flagged for optional spot-check only.'
kill_criteria:
