...
upstream_path: docs/case-studies/pm-workflow-showcase-onboarding.md
tier: flagship
timeline_position:
  version: '2.0'
  order: 1
...
date: '2026-04-05'
tldr: 'First feature run through the full 9-phase PM lifecycle. Retroactive UX/design-system alignment on a "finished" feature surfaced 24 findings (6 P0) plus 5 latent compile bugs the build had been hiding for days.'
key_numbers:
  - label: 'Audit findings (Onboarding)'
    value: '24'
    tier: T1
  - label: 'P0 critical findings'
    value: '6 of 24'
    tier: T1
  - label: 'Latent compile bugs surfaced'
    value: '5'
    tier: T1
honest_disclosures:
...
|--------|-------|
| Wall time | ~6.5 hours |
| <Term slug="complexity-units">Complexity Units</Term> (CU) | 25.7 |
