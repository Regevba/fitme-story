...
date: '2026-04-16'
tldr: >-
  Counterfactual experiment: retroactively applying deterministic measurement
  infrastructure to all 24 features, then computing the cost, the savings, and
  what we would have learned earlier.
key_numbers:
...
honest_disclosures:
  - >-
    Counterfactual ROI — not a real intervention. Estimates derive from the v6.0
    instrumentation cost on the 1 feature that actually used it.
  - >-
    Same-author analysis: the v6.0 builder also wrote and reads this
    retrospective.
visual_aid:
  component: KeyNumbersChart
chrome_minimal: true
chrome_minimal_reason: >-
  Methodology doc (counterfactual ROI analysis), not a feature shipment. No
  kill_criteria or honest_disclosures applicable; the doc itself IS the
  analysis. Audit T9 (G5 frontmatter audit) 2026-05-08.
category: meta
---
