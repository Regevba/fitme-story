...
> ⚙️ **Developer deep-dive.** React · Framer Motion `LayoutGroup` · SVG concentric rings · 11-color skill palette · WCAG AA in dark mode. PM/HR readers: this is how `/pm-flow` was designed to make an 11-skill ecosystem legible to four different audiences at once — skip unless you care about the metaphor reasoning and the animation plumbing.
