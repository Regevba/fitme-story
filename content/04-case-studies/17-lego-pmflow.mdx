...
date: '2026-04-22'
tldr: 'How to render an 11-skill, 10-phase, 15-data-file framework on a single page without it looking like an org chart. The answer: a Lego wall (scattered → snap-into-place), a concentric lifecycle loop, and a discipline about colours.'
key_numbers:
  - label: 'Skills × phases × shared files'
    value: '11 · 10 · 15'
    tier: T1
  - label: 'Page sections (independent, no shared state)'
    value: '7'
    tier: T1
  - label: 'Audiences served by one metaphor'
    value: '4 (HR · PM · dev · academic)'
    tier: T2
honest_disclosures:
...
visual_aid:
  ...
  data:
    value: '11 · 10 · 15'
    label: 'skills × phases × shared files — the scope the page makes legible in under 10 seconds'
category: dev-deepdive
---
...
<HeroMetric value="11 · 10 · 15" label="skills × phases × shared files — the scope the page had to make legible in under 10 seconds" />
...
- **Feedback arc:** A coral arrow from P9 (Learn) back to P0 (Research) sitting *inside* the inner ring, labeled "learn & cycle back." Explicitly drawn — the one thing that makes the framework a loop rather than a pipeline.
