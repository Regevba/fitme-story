...
3. **Evolution Strip.** Six framework versions (v1 → v6.1) as horizontal cards with the shift that defines each.
...
6. **Chip Affinity Map.** 17 chip profiles × 7 skill columns as a heat grid (cross-references /framework HADF).
