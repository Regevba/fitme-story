...
key_numbers:
  ...
  - label: 'Total mechanical gates + advisories'
    ...
    tier: T1
  - label: 'PRs shipped (this session — Claude-supervised)'
    value: '5 (#185, #186, #187, #188, #189)'
    tier: T1
