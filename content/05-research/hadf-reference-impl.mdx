---
title: 17 Chip Profiles Across 6 Vendors — Reference Implementations
slug: hadf-reference-impl
tier: unassigned
...
The <Term slug="hadf">Hardware-Aware Dispatch Framework</Term> (HADF) detects device hardware and cloud inference hardware to optimize AI agent dispatch decisions. This document contains reference implementations for the three core algorithms: device detection (Layer 0), cloud fingerprinting via <Term slug="mahalanobis-distance">Mahalanobis</Term> classification (Layer 2), dynamic adaptation (Layer 3), and composite score computation. These are pseudocode/reference quality -- they validate the design before production implementation.
