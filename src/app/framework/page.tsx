  ...
  return (
    <article className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-[var(--measure-body)] mt-16">
        ...
        <p>
          The framework is organized as eight floors stacked on a shared slab. Floor 1 holds the source-of-truth state. Floor 2 is the hub-and-spoke of skills and their cache tiers. Floors 3–5 add successive SoC-inspired primitives — skill-on-demand loading, batch dispatch, dispatch intelligence. Floor 6 observes the lower floors via the v6.0 measurement overlay. Floor 7 promotes that observation into mechanical enforcement: 25 gates + 1 advisory split across write-time pre-commit hooks, the 72h integrity cycle, a per-PR review bot, a weekly framework-status cron, and the Tier 1/2/3 readout dashboards. Floor 8 is the v7.8 bridge to v7.9 (shipped 2026-05-04): six new advisory mechanisms — A coverage-asserting gates, C session-event attribution, D pre-commit header self-audit, E append-only ledger merge driver, F membrane-status smartlog, plus schema bridge fields populated on 47 features. v7.9 promotion lands ~2026-06-01 after a +7d measurement window confirms zero false-positives.
        </p>
        <p>
