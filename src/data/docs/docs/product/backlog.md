...
> Last updated: 2026-05-06 (cross-reference sync: import-training-plan + onboarding-v2-retroactive moved to Done; Notion Project Context refreshed to v7.8 + 2026-05-06 reality)
...
|------|-------|-------|
| Push notifications v2 | **SHIPPED 2026-05-07 via PR #239** | Single-day full PM cycle rebuild after v1 UI-016 partial-ship. Platform-layer architecture; smart-reminders becomes first consumer (paired backlog enhancement ships separately). Source case study: `docs/case-studies/push-notifications-v2-case-study.md`. |
