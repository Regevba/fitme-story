...
> **Framework state at last update:** PM Framework **v7.10** (GATE_COVERAGE_ZERO observability + field-rename closure, shipped 2026-06-10). Lineage: v7.9 promotion 2026-05-21 → v7.9.1 build window 2026-06-04 → v7.10 2026-06-10. Current canonical counts: **130 features · 32 instrumented gates (20 write-time + 9 cycle-time + 2 W9 hooks + 1 standalone; 34 live), 28 firing · 0 integrity findings** (reconciled 2026-07-10) — see [`../FRAMEWORK-FACTS.md`](../FRAMEWORK-FACTS.md). Canonical entry points:
