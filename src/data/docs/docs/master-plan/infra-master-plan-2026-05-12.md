...
**Canonical current state (reconciled 2026-07-10):** **v7.10 · 130 features · 32 instrumented gates (20 write-time + 9 cycle-time + 2 W9 hooks + 1 standalone; 34 live), 28 firing · 0 integrity findings, 0 real regressions.** Live ref: [`docs/FRAMEWORK-FACTS.md`](../FRAMEWORK-FACTS.md).
