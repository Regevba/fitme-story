...
> **Status: v7.10 SHIPPED 2026-06-10** — GATE_COVERAGE_ZERO observability + field-rename closure. **Current canonical counts** (see [`docs/FRAMEWORK-FACTS.md`](../FRAMEWORK-FACTS.md)): **v7.10 · 106 features · 26 instrumented gates (17 write-time + 7 cycle-time + 2 W9 hooks), 19 firing · 0 integrity findings** (reconciled 2026-06-15). The older "37 mechanical gates + 5 advisories" framing below counted mechanisms+CI-workflows+hooks; the 26-gate figure counts gate codes in the F17 index — both are real, they count different things. Calibration ladder: F16 enforce 06-18 · W9 06-20 · PLATFORMS_TESTED 06-21 · R9→GATE_TEST_MISSING 07-04 · Data Freshness Audit 08-12.
>
