...
> **Currency note:** framework is at **v7.10** (shipped 2026-06-10); the unclosable-gaps status below is unchanged since v7.7 (the four Class B gaps remain mechanically unclosable by design). Canonical current counts: [`../FRAMEWORK-FACTS.md`](../FRAMEWORK-FACTS.md).
>
...
| [data-integrity-telemetry-sweep.md](./data-integrity-telemetry-sweep.md) | — (cross-layer) | Codified one-command cross-layer health verdict (11 layers: framework integrity, regression-vs-anchor, dilution-normalization, adoption/gate telemetry, doc-debt, cross-repo sync, CI automation, GA4, backup, cadence). Shipped 2026-07-13; dilution-normalization layer added 2026-07-21 (PR #934) | `make integrity-sweep` + `scripts/integrity-telemetry-sweep.py` |
